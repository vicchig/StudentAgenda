...
class teacherAssignmentState extends State<teacherAssignmentScreen> {
  ...
  Future<void> retrieveStudents() async {
    List<classroom.CourseWork> allSubscribedCourseWork = await pullCourseWorkData(firebaseUser);
    List<classroom.CourseWork> tempCourseWork = await getCourseWorksForCourse(courseID, allSubscribedCourseWork);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(title: new Text("Class Assignments"), centerTitle: true),
                          ...
                          child: ListTile(
                            ...
                            subtitle:     Text(
                              'Due: ${DateTime(_courseWork[index].dueDate.year,
                                  ...
                                  _courseWork[index].dueDate.day, _courseWork[index]
                                      .dueTime?.hours ?? 0, _courseWork[index].dueTime
