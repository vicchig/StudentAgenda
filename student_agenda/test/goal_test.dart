...
void main(){
  ...
  setUp(() {
    testGoal = new Goal(name: "TestGoal", text: "Test Goal Text", courseID: "1",
        courseWorkID: "23", dueDate: "2019-11-15T10:25:00");
  });
  ...
  group("Goal--TestGetters", () {
    test(".getDueTime() should return a time on the 24-hour clock in the format"
        " hh:mm:ss", (){
    ...
    test(".getCourseWorkId() should correctly return the course work id this"
  ...
  group("Goal--TestStatus", (){
    test(".setStatus() should set status to S_IN_PROGRESS_LATE if the goal has"
    ...
    test(".setStatus() should set status to S_IN_PROGRESS if the due date has"
        " not passed", (){
      expect(testGoal.getStatus(), equals("IN_PROGRESS"));
      testGoal.dueDate = DateTime.now();
    ...
    test(".setStatus() should set status to S_COMPLETED_LATE if the due date has"
    ...
    test(".setStatus() and .completeGoal() should correctly set the goal state"
  ...
  group("Goal--JSON conversion tests", (){
    test("Test to JSON conversion", (){
      ...
      Map<String, dynamic> expected = {
        ...
        "courseID": "1",
        "courseWorkID": "23",
        "dueDate": "2019-11-15T10:25:00.000"
      };
  ...
  group("Goal--TestOther", (){
    test(".toString() should return information about the goal in the correct"
        " format", (){
      expect(testGoal.toString(), equals("TestGoal\n15/11/2019\n10:25:00"
          "\nIN_PROGRESS\n\nTest Goal Text\n\n"));
    });
  });
}